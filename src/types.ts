...
export type ActivityLog = { id: string; name: string; calories: number; date: string; createdAt: string }
export type BodyMeasurement = { id: string; date: string; weight?: number; bodyFat?: number; muscleMass?: number; createdAt: string }
